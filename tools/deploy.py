...
####################################
# cfpu automatic deployment script #
# ================================ #
...
TRANSLATIONBODY = """**[cfpu Translation Guide](http://CFPmod.com/wiki/development/how-to-translate-cfpu.html)**
...
def update_dependencies(repo):
    ...
    if diff != "":
        ...
        repo.update_file(
            ...
            content=dependencies, sha=sha, committer=InputGitAuthor("CFPmod", "tupolov73@gmail.com")
